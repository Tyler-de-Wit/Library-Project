        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="col">
                <div class="text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/frequently-asked-questions-icon.png" alt="Question Icon">
                    <a href="frequently-asked-questions">Frequently Asked Questions</a>
                </div>
            </div>
            <div class="col">
                <div class="text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/contact-icon.png" alt="Mail Icon">
        ...
        <div class="row row-cols-2 g-4">
            ...
            <div class="col">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/blackboard-icon.png" alt="Person Icon">
                    <a href="https://help.blackboard.com/" target="_blank">Blackboard Help</a>
                </div>
            </div>
            <div class="col">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/wifi-icon.png" alt="WiFi Icon">
            ...
            <div class="col">
                <!-- <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/pen-icon.png" alt="Pen Icon">
                    <a href="https://www.mybib.com/tools/apa-citation-generator" target="_blank">APA Citation Generator</a>
                </div> -->
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/document-icon.png" alt="Document  Icon">
                    <a href="https://guides.dtwd.wa.gov.au/nmtafe-library" target="_blank">Library Services</a>
                </div>
            </div>
            <div class="col">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/printers-icon.png" alt="Printer Icon">
            ...
            <div class="col hidden-elements hidden">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/timetable-icon.png" alt="Timetable Icon">
            ...
            <div class="col hidden-elements hidden">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/graduation-icon.png" alt="Graduation Icon">
                    <a href="https://guides.dtwd.wa.gov.au/nmtafe-library/newstudents" target="_blank">New Students</a>
                </div>
            </div>
            <div class="col hidden-elements hidden">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/globe-icon.png" alt="Globe Icon">
            ...
            <div class="col hidden-elements hidden">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/student-portal-icon.png" alt="Student Portal Icon">
            ...
            <div class="col hidden-elements hidden">
                <div class="button-icon-navigation text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/microsoft-365-icon.png" alt="Computer Icon">
